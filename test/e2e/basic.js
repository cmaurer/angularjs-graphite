describe('angularjs.grapahite', function () {
  describe('App', function () {
    ...
    it('should get graphite data', function(){
      ...
      expect(url.getText()).toEqual('http://localhost:9001/render?format=json&from=-1h&until=-15s&target=foobar.one.five&target=foobar.one.six&target=foobar.one.seven&target=foobar.two.five&target=foobar.two.six&target=foobar.two.seven&target=foobar.three.five&target=foobar.three.six&target=foobar.three.seven');
